...
def _build_sam(
    ...
    if checkpoint is not None:
        ...
        if args.model_type == 'vit_b':
            sam_path = os.path.join('Hi-sam/pretrained_checkpoint', 'sam_vit_b_01ec64.pth')
        elif args.model_type == 'vit_l':
            sam_path = os.path.join('Hi-sam/pretrained_checkpoint', 'sam_vit_l_0b3195.pth')
        elif args.model_type == 'vit_h':
            sam_path = os.path.join('Hi-sam/pretrained_checkpoint', 'sam_vit_h_4b8939.pth')
