...
from agents.image_generation.model import T5EncoderModel, FluxTransformer2DModel
...
base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'microAPP_Simulator_ver1.1.8'))
sys.path.insert(0, base_dir)

import api.API_sample as ap
from api.API_sample import image_path_sample , image_Post_sample , clear_canvas
...
def run_agent_image_generation(IP_addr,prompt , save_dir = "temp_storage/id_01.png"):
...
#     image.show()
#     os.wait()
#     image.save(f"temp_storage/id_01.png")
